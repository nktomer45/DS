...
function capitalize(str) {
   const spiltChar=str.split(" ");
   const strCont=[]
   console.log(spiltChar)
   for(let i=0;i<spiltChar.length;i++){
        const word=spiltChar[i]
        strCont.push(word[0].toUpperCase()+word.slice(1).toLowerCase())
   }
   console.log(strCont.join(' '))
   return strCont.join(' ')
}

// console.log(capitalize("jkjhd jdfj jk"))
